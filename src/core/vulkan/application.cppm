...
export module game_engine.core.vulkan:application;
...
namespace {
std::unique_ptr<game_engine::gfx::Model> createCubeModel(game_engine::gfx::Device& device, glm::vec3 offset) {
  std::vector<game_engine::gfx::Model::Vertex> vertices{
  ...
  return std::make_unique<game_engine::gfx::Model>(device, vertices);
}
}  // namespace

namespace game_engine::core::vulkan {
