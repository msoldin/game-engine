...
Pipeline::Pipeline(Device &device, const std::string &vertFile,
...
void Pipeline::defaultPipelineConfigInfo(PipelineConfigInfo &configInfo) {
  ...
  configInfo.dynamicStatesEnabled = {VK_DYNAMIC_STATE_VIEWPORT,
                                     VK_DYNAMIC_STATE_SCISSOR};
  configInfo.dynamicStateInfo.sType =
      VK_STRUCTURE_TYPE_PIPELINE_DYNAMIC_STATE_CREATE_INFO;
  configInfo.dynamicStateInfo.pDynamicStates =
      configInfo.dynamicStatesEnabled.data();
  configInfo.dynamicStateInfo.dynamicStateCount =
      static_cast<uint32_t>(configInfo.dynamicStatesEnabled.size());
